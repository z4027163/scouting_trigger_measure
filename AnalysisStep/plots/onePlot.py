...
def plot():
    ...
    if (opt.VAR == 'mll'):
        h = TH1F("h","h", 50, 0, 100)
        t1.Draw("mll>>h","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5","goff")
    if (opt.VAR == 'pt1'):
        h = TH1F("h","h", 50, 0, 100)
        t1.Draw("pt1>>h","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5","goff")
    if (opt.VAR == 'pt2'):
        h = TH1F("h","h", 50, 0, 100)
        t1.Draw("pt2>>h","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5","goff")
    if (opt.VAR == 'lxy'):
        h = TH1F("h","h", 40, 0, 100)
        t1.Draw("lxy>>h","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5","goff")
    if (opt.VAR =='eff125'):
        hPass125 = TH1F("hPass125", "hPass125", 50, 0, 100)
        t1.Draw("lxy>>hPass125","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5&&pass125==1","goff")
        hAll = TH1F("hAll","hAll", 50, 0, 100)
        t1.Draw("lxy>>hAll","pt1>(mll/3)&&pt2>(mll/4)&&pt1>5&&pt2>5","goff")
        eff = TEfficiency(hPass125,hAll)
    ...
    if (opt.LABEL == 'EGamma 2018'):
        h.SetLineColor(2)
    if ((opt.LABEL == 'DY Simulation') and not (opt.VAR == 'eff125')):
        h.SetLineColor(3)

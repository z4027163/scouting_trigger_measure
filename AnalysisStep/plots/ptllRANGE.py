...
def plot():
    ...
    title = "L1andDSTeff" + " " + opt.TRIG + " " +  opt.YEAR + "ptLLRange"
...
#    print fullRange
    ...
    mllbins = [0.0,5.0,10.0,20.0,30.0,40.0,50.0,70.0]
    massRange = "&& mll > 1 && mll < 10"
...
#            mllbins.append(25.0)
    ...
    drbins = [0.0,0.25,0.5,0.75,1.0,1.5,2.0,2.5]
    ...
    baseCuts = "pt1*4>mll && pt2*4>mll && abs(eta1)<1.9 && abs(eta2)<1.9 && passSel==1 && mediumid==1 "
...
#        cutnum = cutden + " && pass157==1 "
    ...
    tmc.Draw("drll:ptll>>hdenmc","("+cutden+")","goff")
    tmc.Draw("drll:ptll>>hnummc","("+weightmc+")*("+cutnum+")","goff")
    ...
    tdat.Draw("drll:ptll>>hdendat","("+cutden+")","goff")
    tdat.Draw("drll:ptll>>hnumdat","("+cutnum+")","goff")
    ...
    heffdat.GetXaxis().SetTitle("pt_{#mu#mu} (GeV)")
    ...
    shutil.move(os.getcwd() + "/" + title + "_data.png", "/eos/user/c/ccosby/www/darkPhotonl1Study/newTrigEffs/" + title + "_data.png")
...
#    c2.SetLiny()
    ...
    heffmc.GetXaxis().SetTitle("pt_{#mu#mu} (GeV)")
    heffdat.GetYaxis().SetTitle("#Delta R")

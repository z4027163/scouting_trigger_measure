...
def plot():
    ...
    title = "l1_2Deff dr all Pt2" + "AllTrig" +  opt.YEAR + "NewSel"
...
#    print fullRange
    ...
    mllbins = [0.0,0.125, 0.25,0.375, 0.50, 0.675, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0 ]
...
#drbins = [0.0,0.5,1.0,1.5,2.5, 4.0]
    drbins = [0.0,0.125, 0.25,0.375, 0.50, 0.675, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0 ]
...
#        cutnum = cutden + " && pass157==1 "
    ...
    tmc.Draw("abs(eta2):abs(eta1)>>hdenmc","("+cutden+")","goff")
    tmc.Draw("abs(eta2):abs(eta1)>>hnummc","("+weightmc+")*("+cutnum+")","goff")
    ...
    tdat.Draw("abs(eta2):abs(eta1)>>hdendat","("+cutden+")","goff")
    tdat.Draw("abs(eta2):abs(eta1)>>hnumdat","("+cutnum+")","goff")
    ...
    heffdat.GetXaxis().SetTitle("#eta_{1}")
    heffdat.GetYaxis().SetTitle("#eta_{2}")

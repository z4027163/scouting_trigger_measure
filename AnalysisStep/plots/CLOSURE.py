...
def plot():
    ...
    title = "l1_2Deff dr all Pt2" + " _NO_SELECTION_ " +  opt.YEAR + "NewSel"
...
#        cutnum = cutden + " && pass157==1 "
    ...
    if (opt.YEAR =="2018"):
        tmc.Add('/eos/user/c/ccosby/triggerSamples2018/lowMassDrellYanNoNothing/postProc_1.root')
    if (opt.YEAR =="2017"):
    ...
    tcorreffD.SaveAs("modifiedMllEffD"+opt.YEAR+".root")
    ...
    if (opt.YEAR == "2018"):
        latex2.DrawLatex(0.82, 0.93,"61.3 fb^{-1} (13 TeV)")
    if (opt.YEAR == "2017"):

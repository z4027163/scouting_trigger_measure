...
def plot():
    ...
    reso = "0.15"
    #massRange = "&& mll >(0.547-"+reso+") && mll < (0.547+"+reso+")"
    ...
    #baseCuts = "((pt1>3 && pt2>3) || "+twoMuDREta+") && abs(eta1)<1.5 && abs(eta2)<1.5 && numMu == 2 && passSel==1 && mediumid==1"
    ...
    heff_average.GetXaxis().SetTitle("Sub-leading Muon p_{T} [GeV]")
    heff_average.GetYaxis().SetTitle("#Delta R_{#mu#mu}")
    heff_average.GetZaxis().SetTitle("Data Trigger Efficiency")
    heff_average.GetZaxis().SetTitleOffset(1.2)

    heff_average.SetTitleSize(0.045, "xyz")
    heff_average.SetTitleOffset(1.0, "xy")

    heff_average.SetLabelSize(0.04, "xyz")
    heff_average.SetMarkerSize(1.9)
    ...
    latex2.DrawLatex(0.56, 0.815,"p_{T} > 3 GeV")
    latex2.DrawLatex(0.56, 0.760,"| #eta | < 1.9")
    latex2.DrawLatex(0.56, 0.705,"|m - m_{#eta}| < "+reso+" GeV")

...
def plot():
    ...
    cutden = "pt1*3>mll && pt2*4>mll && pt1>4 && pt2>4 && abs(eta1)<1.9 && abs(eta2)<1.9 && abs(eta1)<1.9 && abs(eta2)<1.9 && mll>1.0 && mll<12.0 && passSel==1 && mediumid==1 && pt2>"+pt2min+" && pt2<"+pt2max
    ...
    tmc.Draw("drll>>hdenmc",cutden,"goff")
    tmc.Draw("drll>>hnummc","("+cutnum+")","goff")
    ...
    tdat.Draw("drll>>hdendat","("+weightdata+")*("+cutden+")","goff")
    tdat.Draw("drll>>hnumdat","("+weightdata+")*("+cutnum+")","goff")
